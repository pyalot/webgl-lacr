exports = class Grid
    @title = '1.11 Morph factor between LOD levels'
    @cameraPos = [0, 0.5, 0]
    @cameraPitch = 10
    ...
    constructor: (@app) ->
        ...
        @showMorphFactor = app.addCheckbox(label:'Morph Factor', value:false)
    ...
    draw: ->
        @shader
            ...
            .float('showMorphFactor', @showMorphFactor.numValue)
